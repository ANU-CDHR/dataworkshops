...
#%%
# load the data frame
#df = pd.read_csv(r'./dataframes/retweeted_tweet.csv')
df = pd.read_csv(r'./hashtags_test.csv')

#%%
# convert the dataframe into a Networkx object
G_reply = nx.from_pandas_edgelist(df, 
                                  source='hashtags',
                                  target='quoted_hashtags',
...
plot1 = figure(plot_width=500, plot_height=500,
               ...
               tools=TOOLS, tooltips=([('hashtags', '@index')]),
               toolbar_location=None)

plot1.title.text = "Retweet Network (Spring Layout)"
...
plot2 = figure(plot_width=500, plot_height=500,
            ...
            tools=TOOLS, tooltips=([('hashtags', '@index')]),
            toolbar_location=None)
plot2.title.text = "Retweet Network (Kamada-Kawai Layout)"
...
output_file("quoted_hashtags_networkx_graph2.html")
